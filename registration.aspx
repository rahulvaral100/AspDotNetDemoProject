      ...
      <form action="" runat="server">
        ...
        <div class="row">
          ...
          <div class="reg-col-75">
            ...
            <asp:RegularExpressionValidator ID="namevalidator" CssClass="reg-validator" runat="server" 
        ...
        <div class="reg-row">
          ...
          <div class="reg-col-75">
            ...
            <asp:RegularExpressionValidator ID="eamilvalidator" CssClass="reg-validator" runat="server" 
        ...
        <div class="row">
          ...
          <div class="reg-col-75">
            ...
            <asp:RegularExpressionValidator ID="usernamealidator" CssClass="reg-validator" runat="server" 
        ...
        <div class="row">
          ...
          <div class="reg-col-75">
            ...
            <asp:RegularExpressionValidator ID="passwordvalidator" CssClass="reg-validator" runat="server" 
        ...
        <div class="row">
          ...
          <div class="reg-col-75">
            ...
            <asp:CompareValidator ID="passwordcomparealidator" CssClass="reg-validator" runat="server"  ControlToValidate="password"
        ...
        <div class="reg-row">
          ...
          <div class="reg-col-75">
            ...
            <asp:RegularExpressionValidator ID="contactvalidator" CssClass="reg-validator" runat="server" 
